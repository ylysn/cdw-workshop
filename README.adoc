...
STORED AS TEXTFILE LOCATION 's3a://${bucket_id}/airlines-raw/airlines-csv/flights' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
STORED AS TEXTFILE LOCATION 's3a://${bucket_id}/airlines-raw/airlines-csv/planes' tblproperties("skip.header.line.count"="1");
...
STORED AS TEXTFILE LOCATION 's3a://${bucket_id}/airlines-raw/airlines-csv/airlines' tblproperties("skip.header.line.count"="1");
...
ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n' 
STORED AS TEXTFILE LOCATION 's3a://${bucket_id}/airlines-raw/airlines-csv/airports' tblproperties("skip.header.line.count"="1");
----
